...
# -*- coding: utf-8 -*-
"""
Loan Calculator - Кредитный калькулятор (Азербайджан) v3.0
Интерактивная программа для расчета кредитов с ограничением нагрузки

Новые возможности:
- Максимальная кредитная нагрузка: 10% от дохода
- Автоматический отказ при превышении лимита
- Расчет рекомендуемой суммы кредита
- Учет семейного положения
- Вариативная процентная ставка (11-14% в зависимости от срока)
"""
...
class LoanCalculator:
            ...
            try:
                ...
                if salary_usd < self.min_salary_usd:
                    ...
                    if choice == "1":
                        ...
                        print("⚠️ Запомните: общий доход всех заемщиков должен быть достаточным!")
    ...
    def print_financial_safety(self, analysis):
        ...
        if remaining_percentage >= 90:
            ...
            print("⚠️ Умеренная финансовая устойчивость")
